...
@override
int get hashCode => Object.hash(runtimeType,loggedUser,selectedMediaList,selectedAnime,mediaListEntry,newMediaListEntry,characters,recommendations,const DeepCollectionEquality().hash(episodesInfo),const DeepCollectionEquality().hash(banners),alternateImage,const DeepCollectionEquality().hash(installedExtensions),userLoaded,animeServerDialogReady,selectedExtension,const DeepCollectionEquality().hash(extensionAnimeResults),const DeepCollectionEquality().hash(extensionEpisodeResults),const DeepCollectionEquality().hash(extensionVideoResults),const DeepCollectionEquality().hash(effects));

@override
String toString() {
  return 'AnimeDetailsState(loggedUser: $loggedUser, selectedMediaList: $selectedMediaList, selectedAnime: $selectedAnime, mediaListEntry: $mediaListEntry, newMediaListEntry: $newMediaListEntry, characters: $characters, recommendations: $recommendations, episodesInfo: $episodesInfo, banners: $banners, alternateImage: $alternateImage, installedExtensions: $installedExtensions, userLoaded: $userLoaded, animeServerDialogReady: $animeServerDialogReady, selectedExtension: $selectedExtension, extensionAnimeResults: $extensionAnimeResults, extensionEpisodeResults: $extensionEpisodeResults, extensionVideoResults: $extensionVideoResults, effects: $effects)';
}
...
/// Create a copy of AnimeDetailsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? loggedUser = null,Object? selectedMediaList = null,Object? selectedAnime = null,Object? mediaListEntry = null,Object? newMediaListEntry = null,Object? characters = null,Object? recommendations = null,Object? episodesInfo = null,Object? banners = null,Object? alternateImage = null,Object? installedExtensions = null,Object? userLoaded = null,Object? animeServerDialogReady = null,Object? selectedExtension = freezed,Object? extensionAnimeResults = null,Object? extensionEpisodeResults = null,Object? extensionVideoResults = null,Object? effects = null,}) {
...
@override
int get hashCode => Object.hash(runtimeType,loggedUser,selectedMediaList,selectedAnime,mediaListEntry,newMediaListEntry,characters,recommendations,const DeepCollectionEquality().hash(_episodesInfo),const DeepCollectionEquality().hash(_banners),alternateImage,const DeepCollectionEquality().hash(_installedExtensions),userLoaded,animeServerDialogReady,selectedExtension,const DeepCollectionEquality().hash(_extensionAnimeResults),const DeepCollectionEquality().hash(_extensionEpisodeResults),const DeepCollectionEquality().hash(_extensionVideoResults),const DeepCollectionEquality().hash(_effects));
