...
mixin _$AnilistUserModel {
 ...
 String get id; String get name; String get avatarImage; String get bannerImage; String get accessCode; String get accessToken; String get refreshToken;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,avatarImage,bannerImage,accessCode,accessToken,refreshToken);

@override
String toString() {
  return 'AnilistUserModel(id: $id, name: $name, avatarImage: $avatarImage, bannerImage: $bannerImage, accessCode: $accessCode, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
@useResult
$Res call({
 String id, String name, String avatarImage, String bannerImage, String accessCode, String accessToken, String refreshToken
});
...
/// Create a copy of AnilistUserModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? avatarImage = null,Object? bannerImage = null,Object? accessCode = null,Object? accessToken = null,Object? refreshToken = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String avatarImage,  String bannerImage,  String accessCode,  String accessToken,  String refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AnilistUserModel() when $default != null:
return $default(_that.id,_that.name,_that.avatarImage,_that.bannerImage,_that.accessCode,_that.accessToken,_that.refreshToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String avatarImage,  String bannerImage,  String accessCode,  String accessToken,  String refreshToken)  $default,) {final _that = this;
switch (_that) {
case _AnilistUserModel():
return $default(_that.id,_that.name,_that.avatarImage,_that.bannerImage,_that.accessCode,_that.accessToken,_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String avatarImage,  String bannerImage,  String accessCode,  String accessToken,  String refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _AnilistUserModel() when $default != null:
return $default(_that.id,_that.name,_that.avatarImage,_that.bannerImage,_that.accessCode,_that.accessToken,_that.refreshToken);case _:
  return null;
...
class _AnilistUserModel extends AnilistUserModel {
  const _AnilistUserModel({required this.id, required this.name, required this.avatarImage, required this.bannerImage, required this.accessCode, required this.accessToken, required this.refreshToken}): super._();
...
/// Create a copy of AnilistUserModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? avatarImage = null,Object? bannerImage = null,Object? accessCode = null,Object? accessToken = null,Object? refreshToken = null,}) {
