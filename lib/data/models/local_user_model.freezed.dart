...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,avatarImage,accessToken,refreshToken);

@override
String toString() {
  return 'LocalUserModel(name: $name, avatarImage: $avatarImage, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
class _LocalUserModel extends LocalUserModel {
  const _LocalUserModel({required this.name, required this.avatarImage, required this.accessToken, required this.refreshToken}): super._();
